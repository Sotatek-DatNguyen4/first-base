...
import { checkNumberByASCIIC, formatToNumber } from '../../utils/formatNumber';
...
const CreateCampaign: React.FC<RouteComponentProps> = (props: RouteComponentProps) => {
  ...
  const handleFormSubmit = async (data: any) => {
    const { title, start_time, finish_time, token, addressReceiver, tokenByETH, affiliate } = data;
  ...
  return (
    <DefaultLayout>
      <ButtonLink onClick={goBack} spacing={6} to="/campaigns" text="Back" icon="icon-arrow-left.svg" />
