...
const tableHeaders = ["CAMPAIGN NAME", "START TIME", "FINISH TIME",  "TOKEN SYMBOL", "STATUS", "AFFILIATE"];
    ...
    <DefaultLayout>
      <div className={classes.header}>
        <div className="header-left">
          <Button to="/campaigns/add" text={'Create New Campaign'} icon={'icon_plus.svg'} />
        </div>
