...
import {Button, Dialog, DialogContent, DialogContentText, DialogTitle, Slide, CircularProgress, Tooltip } from '@material-ui/core';
...
import { getTokensByUser, addTokenByUser } from '../../store/actions/token';
        ...
        <div className={styles.rightContainer}>
          <div className={styles.rightContainerBlock}>
            <div className={styles.createButtonWrap}>
              <ButtonLink to="/campaigns/add" icon="icon-plus.svg" className={styles.buttonCreateNew} text="Create new" />
            </div>
